    ...
    <div className="restaurant">
      ...
      <section className="about-restaurant">
        ...
        <h2>Rencontrez notre Chef</h2>
          ...
          <p>
          Le Chef Bakarie est passionné par la gastronomie. Avec une expérience de plus de 15 ans dans des restaurants étoilés, il propose une cuisine à la fois créative et respectueuse des traditions culinaires françaises.
